...
These are proposed working responsibilities based on the project direction. Confirm names and availability in T01.
...
| Robotics and test partner — name to be recorded | Chassis, MCU protocol, odometry, LiDAR/SLAM/Nav2, physical setup, fault injection | Replay and challenge Frank's perception/identity results. |
...
- Partner name / GitHub handle: **TBD**
